        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stok" class="form-control" id="exampleFormControlInput1" placeholder="input stok">
                    @error('stok')
                    <div class="alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="harga" class="form-control" id="exampleFormControlInput1" placeholder="input harga">
                    @error('harga')
                    <div class="alert-danger">{{ $message }}</div>
                    @enderror
                </div>
